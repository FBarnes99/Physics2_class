...
public:
	...
	void CreateCircle(int posx,int posy,float radius);
	void CreateBox(int posx,int posy,int heigth, int width);
	void CreateChain(int posx, int posy,int vertexs[],int NumberV);
